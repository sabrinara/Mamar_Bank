...
def send_transaction_money_email(user, amount, subject, template, current_balance):
    message = render_to_string(template, {
        'user': user,
        'amount': amount,
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            try:
                ...
                send_transaction_money_email(current_user,amount,'Transfer Message','transactions/transfered_email.html',current_user.balance)
                send_transaction_money_email(to_user, amount,'Received Message', 'transactions/received_email.html', to_user.balance)
